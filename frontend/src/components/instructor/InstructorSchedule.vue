    ...
    <div>
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
        ...
        <div class="mt-4 flex gap-4 text-sm text-gray-600">
          <span class="flex items-center gap-2"><div class="w-3 h-3 bg-green-100 rounded"></div>Available</span>
...
export default {
  ...
  setup() {
    ...
    const getStatusClass = (available) => (available === 0 ? 'text-red-600 font-semibold' : 'text-green-600 font-semibold')
