    ...
    <div>
          ...
          <div class="w-2/3 flex flex-col">
            ...
            <div v-if="selectedConversation" class="p-4 bg-blue-800 text-white flex justify-between items-center">
              <div class="flex items-center gap-3">
                <div class="w-8 h-8 bg-white text-blue-800 rounded-full flex items-center justify-center text-sm font-bold">
              ...
              <div class="flex gap-2">
                <button 
                  ...
                  class="text-xs bg-blue-900 hover:bg-blue-700 text-white px-3 py-1 rounded"
                >
                  Archive
                </button>
                <button 
            ...
            <div v-if="selectedConversation" class="flex-1 overflow-y-auto p-4 bg-gray-50">
              <div class="space-y-4">
                <div
                  ...
                  :key="message.id"
                  :class="['flex', message.sender === 'trainer' ? 'justify-end' : 'justify-start']"
                >
                  <div
                    :class="[
            ...
            <div v-if="selectedConversation" class="border-t border-gray-200 p-4">
              <div class="flex gap-2">
                <input
                  ...
                  class="flex-1 p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500"
                >
                <button
                  @click="sendMessage"
                  :disabled="!newMessage.trim()"
                  class="px-4 py-3 bg-blue-700 text-white rounded-md hover:bg-blue-800 disabled:bg-gray-400 disabled:cursor-not-allowed"
                >
                  Send
                </button>
              </div>
      ...
      <div class="mt-8 bg-white p-6 rounded-xl shadow-sm border border-gray-200">
        <div class="flex justify-between items-center mb-4">
          <h3 class="text-lg font-bold text-blue-800">Recent Contacts</h3>
          <button
...
export default {
  ...
  setup() {
    ...
    const conversations = ref([
      ...
      },
      {
        ...
        messages: [
          ...
          { id: 2, text: "Noted. I will submit it today.", sender: "trainer", timestamp: "2025-11-14T14:35:00" },
        ],
      },
    ]);
    ...
    const recentContacts = ref([
      ...
      { id: 5, name: "Trainer Buddy", role: "Trainer", type: "trainer" },
      { id: 6, name: "Trainer Lead", role: "Trainer", type: "trainer" },
    ]);
    ...
    const getAutoReply = () => {
      const replies = ["Noted, thank you!", "Okay, thank you!", "Copy that!", "Understood.", "Thanks for the update!"];
    ...
    const archiveConversation = (conversation) => {
      ...
      if (selectedConversation.value?.id === conversation.id) selectedConversation.value = null;
    };
    ...
    const sendNewMessage = () => {
      ...
      const newConversation = {
        ...
        unreadCount: 0,
        messages: [
          { id: 1, text: newMessageContent.value, sender: "trainer", timestamp: new Date().toISOString() },
        ],
      };
